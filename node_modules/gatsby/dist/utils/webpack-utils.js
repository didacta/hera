  ...
  var _ref = (0, _asyncToGenerator2.default)(function* ({
    ...
    const loaders = {
      ...
      postcss: (options = {}) => {
        let cssnano = options.cssnano,
            ...
            _options$minimze = options.minimze,
            minimze = _options$minimze === void 0 ? PRODUCTION : _options$minimze,
            postcssOpts = (0, _objectWithoutProperties2.default)(options, ["cssnano", "plugins", "browsers", "minimze"]);
        return {
          ...
          options: Object.assign({
            ...
            plugins: loader => {
              ...
              return [minimze && require(`cssnano`)(cssnano), flexbugs, autoprefixer({
                browsers,
                flexbox: `no-2009`
...

    {
      const css = (_ref2 = {}) => {
        let browsers = _ref2.browsers,
            options = (0, _objectWithoutProperties2.default)(_ref2, ["browsers"]);
    ...
    plugins.uglify = (_ref3 = {}) => {
      let uglifyOptions = _ref3.uglifyOptions,
          options = (0, _objectWithoutProperties2.default)(_ref3, ["uglifyOptions"]);
